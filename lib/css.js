...
// CSS injected once per page via after_render:html
function getCSS() {
  return `
<style data-hexo-design-cards>
/* hexo-design-cards base styles */
...
.dc-card-body p{font-size:14px;color:#555;margin:0 0 10px}
...
.dc-accent{padding:15px;border-radius:8px;border-left:4px solid}
.dc-accent b{display:block;margin-bottom:4px}
.dc-accent p{font-size:13px;margin:5px 0 0;color:#555}

.dc-compare{display:grid;grid-template-columns:1fr 1fr;gap:20px;margin:20px 0}
.dc-compare-option{padding:20px;border-radius:12px;border-width:1px;border-style:solid}
...
.dc-compare-option .dc-subtitle{text-align:center;font-weight:bold;margin-bottom:10px}
.dc-compare-option p{font-size:14px;color:#555;line-height:1.6}

.dc-quotes{border-width:1px;border-style:solid;border-radius:12px;padding:20px;margin:25px 0}
...
.dc-alert p,.dc-alert div{margin:0;font-size:14px;line-height:1.8}

.dc-minicards{display:grid;grid-template-columns:repeat(3,1fr);gap:15px;margin:20px 0}
.dc-mini{border-width:1px;border-style:solid;border-radius:8px;padding:15px}
